        ...
        <div class="main">
            ...
            <div class="course-tab">
                <ul class="tab-list">
                    ...
                    <li :class="tabIndex==3?'active':''" @click="tabIndex=3">用户评论 ({{this.msgs.length}})</li>
            ...
            <div class="course-content">
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="i in chapter_list">
                            <div class="chapter-title">
                                <img src="" alt="">第{{i.chapter}}章·{{i.name}}
                            </div>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="(j,index) in i.coursesections">
                ...
                <div class="course-side">
                    <div class="teacher-info">
                        ...
                        <div class="teacher-content">
                            <div class="cont1">
                                <img :src="teacher_list.image">
                                <div class="name">
                                    <p class="teacher-name">{{teacher_list.name}}</p>
                                    <p class="teacher-title">{{teacher_list.signature}}</p>
                                </div>
                            </div>
                            <p class="narrative">{{teacher_list.title}},技术专家，百知教育金牌讲师，独有的闷骚气质撩到爆炸</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        data() {
            return {
                msg: '',
                msgs: [],
                // course_name_id:'',  //传递过来的当前id
                course_list: [],     //  课程列表
                // lesson_list: [],     //  课程列表
                chapter_list: [],     //  章节列表
                teacher_list: [],     //  laoshi列表
                // course_capter_list: [],     //  章节列表
                course_id: 0,
        ...
        methods: {
            ...
            get_course_list() {
                ...
                this.course_id = id;
                this.$axios.get(`${this.$settings.HOST}course/list_name/${id}/`).then(response => {
                    console.log(response.data);
                    this.course_list = response.data;
                    this.teacher_list = response.data.teacher;
